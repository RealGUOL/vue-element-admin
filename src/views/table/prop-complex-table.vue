<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="Scan Gun Code" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.scanGunCode }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Prop Type" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.propType }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Prop Total" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.propTotal }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Prop Stock" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.propStock }}</span>
        </template>
      </el-table-column>
      <el-table-column label="Pic" width="150px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.pic }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="Used Id" width="150px" align="center">
        <template slot-scope="{row}">
